...
// executes the function fun with the given parameters one time and returns the
...
// executes fun with the given parameters n times and returns the total
// execution time
...
// executes fun with the given parameters n times and returns the average
// execution time per call of fun
